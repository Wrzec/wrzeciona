...
$smarty->assign('page_title','Kantor');
$smarty->assign('page_description','Zadanie ze smarty');
$smarty->assign('page_header','Oblicz kurs EUR na PLN i odwrotnie :)');
